    ...
    <div className="page-fade band" style={{ paddingTop: 160 }}>
      <div className="band__inner" style={{ maxWidth: 820, margin: '0 auto' }}>
        ...
        <ul className="a11y-list">
          <li><strong>Information you give us.</strong> When you submit a form on this site, we collect the details you provide. depending on the form, this may include your name, email address, phone number, real estate experience, investment preferences, and the general amount you are considering. Please do not submit bank account numbers, Social Security numbers, or other sensitive identifiers through this site.</li>
          <li><strong>Information collected automatically.</strong> Our hosting and form providers may log standard technical data such as IP address, browser type, and pages visited, for security and to keep the site running. We do not use advertising trackers.</li>
        </ul>
        ...
        <p className="body-lg">
          Form submissions are processed through Google Forms, and the site is hosted on a third-party hosting provider. These providers process data on our behalf under their own terms and privacy policies. We may also link out to LinkedIn, Substack, and Instagram, which are governed by their own privacy practices.
        </p>
