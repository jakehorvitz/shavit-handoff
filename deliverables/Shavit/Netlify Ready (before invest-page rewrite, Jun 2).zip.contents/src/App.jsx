/* global React, ReactDOM, Nav, MenuOverlay, Footer, HomePage, CompaniesPage, CaseStudiesPage, MeetPage, ContactPage, AccessibilityPage, LegalPage, LogoIntro, FormModal, CursorRing, ScrollProgress, FilmGrain */
...
function App() {
  ...
  const labels = { home: '01 Home', companies: '02 Companies', 'case-studies': '03 Case Studies', meet: '04 Meet Shavit', contact: '05 Contact', accessibility: '06 Accessibility', legal: '07 Legal & Privacy' };
