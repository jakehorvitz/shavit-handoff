  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__grid">
        ...
        <div className="footer__col">
          ...
          <ul>
            ...
            <li><a href="#" onClick={(e) => go(e,'companies')}>Long-Term Residential</a></li>
            <li><a href="#" onClick={(e) => go(e,'companies')}>Mid-Term Professional</a></li>
            <li><a href="#" onClick={(e) => go(e,'companies')}>Overlooked Assets</a></li>
          </ul>
        </div>
        <div className="footer__col">
          <h5>Connect</h5>
      ...
      <div className="footer__disclaimer">
        Not an offer to sell or a solicitation to buy any security. Informational only; not investment, legal, or tax advice. Real estate investing carries risk, including loss of principal. See <a href="#" onClick={(e) => go(e,'legal')}>Legal &amp; Privacy</a>.
      </div>
    </footer>
  );
}
