...
const MILESTONES = [
  ...
  { value: 30,  label: 'Jobs Created',       sub: 'Locally, on the ground' },
];
        ...
        <div className="progvis__head">
          ...
          <Reveal mode="fade" delay={900}>
            <p className="body-lg" style={{ maxWidth: 680, marginTop: 16 }}>
              The plan: 100 homes revitalized in Hillsdale, 200 doors across the Midwest, and 30 jobs created locally by 2030. We&rsquo;re {pct}% of the way to the first milestone.
            </p>
          </Reveal>
        </div>
