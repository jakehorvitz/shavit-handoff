    ...
    <header className={`nav ${scrolled ? 'nav--scrolled' : ''}`}>
      <div className="nav__inner">
        ...
        <a
          ...
          aria-label="Charger Realty Management, by Shavit Rootman. Home"
        >
          Charger<span className="nav__wordmark-gold">Realty Management</span>
        </a>
        <div className="nav__right">
          ...
          <a
            className="nav__cta"
            href="#"
            onClick={(e) => { e.preventDefault(); window.dispatchEvent(new CustomEvent('open-form-modal', { detail: { type: 'work' } })); }}
          >
            Work With Me
          </a>
        </div>
