...
// then each letter of CHARGER REALTY MANAGEMENT slides up with brass-fill stagger,
  ...
  return (
    <div className={`intro intro--${phase}`} aria-hidden="true">
      ...
      <div className="intro__mark">
        ...
        {/* CHARGER */}
        <span className="intro__line intro__line--a" aria-label="Charger">
          {splitLetters('CHARGER', 700)}
        </span>

        {/* REALTY MANAGEMENT — gold descriptor */}
        <span className="intro__line intro__line--b" aria-label="Realty Management" style={{ fontSize: 'clamp(18px, 3vw, 38px)', letterSpacing: '0.28em' }}>
          {splitLetters('REALTY MANAGEMENT', 1100)}
        </span>
        ...
        {/* Caption */}
        <span className="intro__caption">by Shavit Rootman</span>
      </div>
    </div>
  );
}
