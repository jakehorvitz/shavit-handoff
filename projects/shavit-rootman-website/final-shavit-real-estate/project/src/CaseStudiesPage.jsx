...
const CASES = [
  ...
  },
  {
    ...
    src: SHAVIT_PHOTOS.pWestCleveland, filter: 'contrast(1.03)',
    outcomes: [
    ...
    <div className="page-fade">
      ...
      <section className="hero hero--80vh hero--enter">
        <div className="hero__media">
          <Placeholder src={SHAVIT_PHOTOS.pRiver} filter="brightness(0.5) saturate(1.05) contrast(1.03)" label="Portfolio property · Hillsdale" kind="video" />
        </div>
