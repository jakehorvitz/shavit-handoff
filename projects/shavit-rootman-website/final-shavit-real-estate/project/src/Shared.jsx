...
const SHAVIT_PHOTOS = {
  ...
  /* Real portfolio properties (from Instagram @shavitness / portfolio PDF) */
  pRiver:        res('pRiver',        'assets/properties/01_river_street_hillsdale.jpg'),
  pMead:         res('pMead',         'assets/properties/02_34_mead_street_hillsdale.jpg'),
  pParkview:     res('pParkview',     'assets/properties/03_2217_parkview_south_bend.jpg'),
  pClevHeights:  res('pClevHeights',  'assets/properties/04_cleveland_heights.jpg'),
  pWestCleveland:res('pWestCleveland','assets/properties/05_west_side_cleveland.jpg'),
  pSalem:        res('pSalem',        'assets/properties/06_61_salem_street_hillsdale.jpg'),
  pLarchmere:    res('pLarchmere',    'assets/properties/07_larchmere_duplex_cleveland.jpg'),
  pStJoe:        res('pStJoe',        'assets/properties/08_east_saint_joe_hillsdale.jpg'),
  pBudlong:      res('pBudlong',      'assets/properties/09_budlong_street_hillsdale.jpg'),
  pSecondChance: res('pSecondChance', 'assets/properties/10_second_chance_ranch_hillsdale.jpg'),
