  ...
  work: {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          { name: 'structure', label: 'What structure are you interested in?', type: 'checkbox', required: true, entryId: 'entry.PLACEHOLDER_WORK_STRUCTURE',
            options: ['Debt (fixed percentage return on borrowed money)', 'Equity in Projects (passive ownership)', 'Either'] },
          { name: 'amount', label: 'How much are you looking to invest?', placeholder: 'Minimum is typically ~$50K', type: 'text', required: true, entryId: 'entry.PLACEHOLDER_WORK_AMOUNT' },
          { name: 'term', label: 'Ideal length of term', type: 'radio', required: true, entryId: 'entry.PLACEHOLDER_WORK_TERM',
      ...
      },
      {
        ...
        fields: [
          { name: 'accredited', label: 'Are you an accredited investor?', type: 'radio', entryId: 'entry.PLACEHOLDER_WORK_ACCREDITED',
  ...
  invest: {
    ...
    sections: [
      ...
      },
      {
        label: 'What you\u2019re looking for',
        fields: [
          { name: 'option', label: 'What investment option interests you?', type: 'radio', required: true, entryId: 'entry.PLACEHOLDER_INVEST_OPTION',
            options: ['Debt Partnership (Fixed return on the money you Borrow)', 'Equity Partnership (Passive project ownership)', 'I am not sure'] },
          { name: 'amount', label: 'How much do you have available to invest?', placeholder: 'Minimum usually $20K', type: 'text', required: true, entryId: 'entry.PLACEHOLDER_INVEST_AMOUNT' },
          { name: 'duration', label: 'Expected duration of term', type: 'radio', required: true, entryId: 'entry.PLACEHOLDER_INVEST_DURATION',
