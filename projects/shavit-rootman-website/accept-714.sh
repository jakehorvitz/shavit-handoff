...
must_have=(
  "info@chargerpropertymanagement.com"
  "Live with us."
  "Lease Signed"
  "Coming Soon"
  "115 Oak St"
  ...
  "1114 Cedar St"
  "Niles, Michigan"
  "1902 E Ewing Ave" # was "East" — abbreviated 8/27 to match site-wide style (11 E St Joe, 60 S Norwood)
  "Deal Case Studies"
  "Tenants Q&amp;A"
  "Investors Q&amp;A"
  "Meet our Founder"
...
must_not=(
  # "34 Mead" RETIRED from this list 8/27: Shavit's 3:48 PM case-study text made
  # the address public content (homepage card + /case-studies/34-mead/), the same
  # retirement Clarendon got 8/21. Third instance of the content-dependent-
  # assertion trap — the other pruned addresses below stay banned.
  "61 Salem"
  "46 W South"
  "12 River St"
  "15 Waldron"
